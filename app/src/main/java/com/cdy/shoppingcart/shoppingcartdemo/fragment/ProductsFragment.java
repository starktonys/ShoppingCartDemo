...
public class ProductsFragment extends Fragment
  ...
  public void initData() {
    ...
    sectionedAdapter.SetOnSetHolderClickListener(new TestSectionedAdapter.HolderClickListener() {
      ...
      @Override public void onHolderClick(Drawable drawable, int[] start_location) {
    ...
    mainlist.setAdapter(new ArrayAdapter<String>(getActivity(), R.layout.categorize_item, strings));
  ...
  @SuppressLint("NewApi") private void setAnim(Drawable drawable, int[] start_location) {
    Animation mScaleAnimation =
        new ScaleAnimation(1.2f, 0.6f, 1.2f, 0.6f, Animation.RELATIVE_TO_SELF, 0.5f,
    ...
    Animation mRotateAnimation =
        new RotateAnimation(0, 180, Animation.RELATIVE_TO_SELF, 0.3f, Animation.RELATIVE_TO_SELF,
            0.3f);
